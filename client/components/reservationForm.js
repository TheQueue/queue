  ...
  handleFetch(response) {
    ...
    const schedule = !appointments.length
      ...
      : appointments.reduce((currentSchedule, appointment) => {
          ...
          currentSchedule[dateString] = !currentSchedule[date]
            ? Array(8).fill(false)
            : null
          currentSchedule[dateString][slot] = Array.isArray(
    ...
    return (
      <div>
        ...
        >
          ...
          <a style={{textDecoration: 'none'}} href={this.state.contactPageUrl}>
